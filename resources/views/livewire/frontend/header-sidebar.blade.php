                                            ...
                                            <div class="container-mega">
                                                <ul class="megamenu">
                                                    ...
                                                    <li class="item-vertical">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                            <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico1.png" alt="icon">
                                                    ...
                                                    <li class="item-vertical  style1 with-sub-menu hover">
                                                        ...
                                                        <a href="#" class="clearfix">
                                                            ...
                                                            <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico9.png" alt="icon">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="row banner">
                                                                            <a href="#">
                                                                                <img src="{{ asset('supermarke/') }}/image/catalog/menu/megabanner/vbanner1.jpg" alt="banner1">
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <li class="item-vertical with-sub-menu hover">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico7.png" alt="icon">
                                                    ...
                                                    <li class="item-vertical css-menu with-sub-menu hover">
                                                        ...
                                                        <a href="#" class="clearfix">
                                                             ...
                                                             <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico6.png" alt="icon">
                                                    ...
                                                    <li class="item-vertical">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico5.png" alt="icon">
                                                            <span>Health & Beauty</span>
                                                    ...
                                                    <li class="item-vertical">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico4.png" alt="icon">
                                                            <span>Bathroom</span>
                                                        </a>
                                                    </li>
                                                    <li class="item-vertical">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico3.png" alt="icon">
                                                    ...
                                                    <li class="item-vertical" >
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                            <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico2.png" alt="icon">
                                                            <span>Bedroom</span>
                                                        </a>
                                                    </li>
                                                    <li class="item-vertical" >
                                                    ...
                                                    <li class="item-vertical" style="display: none;">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico11.png" alt="icon">
                                                    ...
                                                    <li class="item-vertical" style="display: none;">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="{{ asset('supermarke/') }}/image/catalog/menu/icons/ico12.png" alt="icon">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="home2.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="{{ asset('supermarke/') }}/image/catalog/menu/home-2.jpg" alt="">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="home3.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="{{ asset('supermarke/') }}/image/catalog/menu/home-3.jpg" alt="">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="html_with_RTL/index.html" class="image-link">
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="{{ asset('supermarke/') }}/image/catalog/menu/rtl.jpg" alt="">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3 img img2">
                                                                            <a href="#"><img src="{{ asset('supermarke/') }}/image/catalog/menu/megabanner/image-2.jpg" alt="banner2"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img3">
                                                                            <a href="#"><img src="{{ asset('supermarke/') }}/image/catalog/menu/megabanner/image-3.jpg" alt="banner3"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img4">
                                                                            <a href="#"><img src="{{ asset('supermarke/') }}/image/catalog/menu/megabanner/image-4.jpg" alt="banner4"></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
