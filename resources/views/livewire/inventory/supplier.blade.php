                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2" wire:click="CategoryModal"><i class="mdi mdi-plus mr-1"></i> New Supplier</button>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="basicpill-lastname-input">Supplier Company Name</label>
                                                <input class="form-control" type="text" wire:model.lazy="supplierCompanyName" placeholder="Enter Supplier Company Name">
                                                 @error('supplier company name') <span class="error">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="basicpill-firstname-input">Supplier Name</label>
                                                <input class="form-control" type="text" wire:model.lazy="supplierName" placeholder="Supplier Name">
                                                 @error('supplier name') <span class="error">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
