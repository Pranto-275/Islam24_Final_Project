                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" wire:model.lazy="user_id" placeholder="Enter user id">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" wire:model.lazy="branch_id" placeholder="Enter user id">
