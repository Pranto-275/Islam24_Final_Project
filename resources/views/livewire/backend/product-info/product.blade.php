    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input id="low_alert" type="number" step="any" class="form-control" wire:model.lazy="low_alert"
            ...
            <div wire:ignore class="form-group">
                ...
                <textarea class="form-control" id="long_description" rows="3" wire:model.lazy="long_description"
...
<div class="card">
                    ...
                    <div class="col-md-8">
                        ...
                        @foreach ($QueryUpdate->ProductImageTop4 as $image)
                            <div ng-repeat="file in imagefinaldata" class="img_wrp m-1">
                                <img style="height:30px; weight:30px;" src="{{ asset('storage/photo/'.$image->image) }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            @if ($product_image)
            <img src="{{ $product_image->temporaryUrl() }}" style="height:150px; weight:150px;" alt="Image"
                class="img-circle img-fluid">
            @endif
            @if($QueryUpdate && !$product_image)
            {{-- <img @if($QueryUpdate->ProductImageFirst) src="{{ asset('storage/photo/'.$QueryUpdate->ProductImageFirst->image)}}"
            @endif
            ...
            <div ng-repeat="file in imagefinaldata" class="img_wrp m-1">
                ...
                <img style="height:150px; weight:150px;"
                    ...
                    class="rounded mb-1 imgResponsiveMax" alt="" />
                <div class="close text-danger" wire:click="imageDelete({{$QueryUpdate->ProductImageFirst->id}})"
    ...
    <div class="col-md-6">
        ...
        @foreach ($QueryUpdate->ProductImageTop4 as $image)
        <div ng-repeat="file in imagefinaldata" class="img_wrp m-1">
            <img style="height:100px; weight:100px;" src="{{ asset('storage/photo/'.$image->image) }}"
                class="rounded mb-1 imgResponsiveMax" alt="" />
            <div class="close text-danger" wire:click="imageDelete({{$image->id}})" style="cursor:pointer;">
                <span aria-hidden="true">&times;</span>
            </div>
        ...
        <div ng-repeat="file in imagefinaldata" class="img_wrp m-1">
            <img src="{{ $image->temporaryUrl() }}" style="height:100px; weight:100px;" alt="Image"
                class="img-circle img-fluid rounded mb-1 imgResponsiveMax">
...
<center>
    <button type="submit" class="btn btn-primary mr-1 waves-effect waves-light" wire:target="product_image, images"
        wire:loading.attr="disabled">Publish</button>
</center>
</div> <!-- end card-->
{{--
        <div class="card">
