                                                ...
                                                <div>
                                                    ...
                                                    <form>
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" id="billing-name" wire:model.lazy="name" placeholder="Enter your name">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                            <label for="billing-email-address" class="col-md-2 col-form-label">Email Address</label>
                                                            <div class="col-md-10">
                                                                <input type="email" class="form-control" id="billing-email-address" wire:model.lazy="email" placeholder="Enter your email">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                            <label for="billing-phone" class="col-md-2 col-form-label">Phone</label>
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" id="billing-phone" wire:model.lazy="phone" placeholder="Enter your Phone no.">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                            <label for="billing-address" class="col-md-2 col-form-label">Address</label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control" id="billing-address" rows="3" wire:model.lazy="address" placeholder="Enter full address"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                            <label class="col-md-2 col-form-label">Country</label>
                                                            <div class="col-md-10">
                                                                <select class="form-control select2" wire:model.lazy="country" title="Country">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-md-10">
                                                                <select class="form-control select2" wire:model.lazy="state" title="Country">
                                                        ...
                                                        <div class="form-group row mb-0">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="form-control" id="example-textarea" rows="3" wire:model.lazy="note" placeholder="Write some note.."></textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="p-4 border">
                                                        <form>
                                                            <div class="form-group mb-0">
                                                                ...
                                                                <input type="text" class="form-control" id="cardnumberInput" wire:model.lazy="card_number" placeholder="0000 0000 0000 0000">
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="form-group mt-4 mb-0">
                                                                        <label for="cardnameInput">Name on card</label>
                                                                        <input type="text" class="form-control" id="cardnameInput" wire:model.lazy="card_name" placeholder="Name on Card">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group mt-4 mb-0">
                                                                        <label for="expirydateInput">Expiry date</label>
                                                                        <input type="text" class="form-control" id="expirydateInput" wire:model.lazy="expire_date" placeholder="MM/YY">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group mt-4 mb-0">
                                                                        <label for="cvvcodeInput">CVV Code</label>
                                                                        <input type="text" class="form-control" id="cvvcodeInput" wire:model.lazy="cvv_code" placeholder="Enter CVV Code">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
