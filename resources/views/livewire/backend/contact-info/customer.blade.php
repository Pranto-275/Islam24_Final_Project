                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button"
                                    ...
                                    wire:click="ContactModal"><i class="mdi mdi-plus mr-1"></i>Customer</button>
                            </div>
                        </div><!-- end col-->
                    </div>
                    <div wire:ignore class="table-responsive">
                        <div wire:ignore class="table-responsive">
                            <table class="table table-bordered dt-responsive nowrap" id="ContactTable"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="basicpill-lastname-input">Customer Type</label>
                                    <select class="form-control" wire:model.lazy="contact_type">
                                        <option value="Retailer">Retailer</option>
                                        <option value="Wholesale">Wholesale</option>
                                    </select>
                                    @error('contact_type') <span class="error">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" wire:model.lazy="first_name"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" wire:model.lazy="last_name"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" wire:model.lazy="shipping_address"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" wire:model.lazy="due_date"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" wire:model.lazy="birthday"
