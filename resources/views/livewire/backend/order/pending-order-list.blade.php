                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered mb-0 table-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{$pendingOrder->Contact->first_name}}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{$pendingOrder->shipping_charge}}
                                            </td>
                                            <td>
                                                {{$pendingOrder->payable_amount}}
                                            </td>
                                            {{-- <td wire:ignore>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-sm btn-block mb-1" href="{{ route('order.pending-order-invoice',['id'=>$pendingOrder->id]) }}"><i class="fas fa-eye font-size-18"></i></a>
                                            </td>
                                        </tr>
                                         @endforeach
                                        </tbody>
