                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100 slider-image" @if($sliderImageLast)
                                src="{{ asset('storage/photo/'.$sliderImageLast->image) }}" @endif alt="First slide">
                        </div>
                        @foreach ($sliderImages as $sliderImage)

                        <div class="carousel-item">
                            <img class="d-block w-100 slider-image"
                                src="{{ asset('storage/photo/'.$sliderImage->image) }}" alt="Second slide">
                        </div>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item" data-interval="4000">
                            <div class="row">
                                ...
                                @if($flag<4) @php $p++; @endphp <div class="col-3">
                                    <a href="{{ route('search-category-wise',['id'=>$topCategory->id]) }}">
                                        <img class="d-block w-100"
                                            src="{{ asset('storage/photo/'.$topCategory->image1) }}" alt="">
                                        <div class="text-center"
