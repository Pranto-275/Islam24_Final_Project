                    ...
                    <div class="col-8">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <span style="color: rgb(8, 0, 0);">সর্বনিম্ন অর্ডার: </span> <span
                    ...
                    <div class="col-6">
                        <center>
                            <a id="addToCart" class="cart-button cart-button1 mobile-modal-add-to-card"
                                style="background-color: rgb(139, 39, 39); color: white; font-weight: bold;">আরও পণ্য
                                কিনুন</a>
                        </center>
                    </div>
                    ...
                    <div class="col-6">
                        <center>
                            <a id="addToCart" class="cart-button cart-button1 mobile-modal-add-to-card"
                                ...
                                style="background-color: rgb(139, 39, 39); color: white; font-weight: bold;">অর্ডার শেষ
                                করুন</a>
                        </center>
                    </div>
...
<footer id="mobileResponsiveFooter" style="z-index: 1;">
    <div class="card">
        ...
        <div class="col-3 pt-1 text-center">
            {{-- <i class="fas fa-shopping-cart mt-2" style="font-size: 30px;"></i> --}}
            <li class="header-shop-cart">
                <a href="{{url('/')}}"><i class="fas fa-bullhorn text-dark" style="font-size: 20px;"></i>
                </a>
                <br>
