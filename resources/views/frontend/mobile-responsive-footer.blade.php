        ...
        <div class="card-body m-0 p-0">
          <div class="row">
            <div class="col-3 text-center">
                ...
                <li class="header-shop-cart"><a href="#"><i class="fas fa-shopping-cart mt-2" style="font-size: 30px;"></i><span class="cart-count">{{ $cardBadge['data']['number_of_product'] }}</span></a>
            </div>
