          ...
          <div class="row">
            ...
            <div class="col-3 pt-1 text-center">
                ...
                <li class="header-shop-cart"><a href="{{ route('cart') }}">
                    <i class="fas fa-shopping-cart text-dark" style="font-size: 20px;"></i><span class="cart-count" style="background-color: #ff0000;">{{ $cardBadge['data']['number_of_product'] }}</span></a><br>
