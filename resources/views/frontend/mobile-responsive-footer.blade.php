        ...
        <div class="card-body m-0 p-0">
          <div class="row">
            ...
            <div class="col-3 py-3 text-center">
                ...
                <li class="header-shop-cart"><a href="{{ route('check-out') }}"><i class="fas fa-shopping-cart" style="font-size: 30px;"></i><span class="cart-count">{{ $cardBadge['data']['number_of_product'] }}</span></a>
            </div>
            <div class="col-3 py-3 text-center">
