                    ...
                    <div class="my-account-bg" data-background="{{ URL::asset('venam/') }}/img/bg/my_account_bg.png">
                        <div class="my-account-content">
                            ...
                            <div class="direct-login">
                                <a class="btn-hover" href="{{route('register')}}" style="background-color: red;font-weight: bold;" onmouseover="play()"><i class="form-grp-btn"></i>রেজিষ্ট্রেশন করুন</a>
                            ...
                            <form method="POST" action="{{ route('customer_sign_in') }}" class="login-form">
                                ...
                                <div class="form-grp-btn">
                                    ...
                                    <button class="btn" type="submit" style="background: #ff6000;color:white;" onmouseover="play()">
                                        {{ __('লগইন') }}
                                    </button>
                                </div>
                            </form>
